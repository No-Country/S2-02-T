            ...
            <div className="col-1"></div>
              ...
              <div className="col-md-4">
                  <div className="card">
                      ...
                      <div className="card-body">
                      <h5 className="card-title text-xl-center">Orlando Neris - Backend</h5>
                      <div className="row">
                      <div className="col col-sm"></div>
                        <div className="col col-sm-4">
              ...
              <div className="col-md-4">
                  <div className="card">
                      ...
                      <div className="card-body">
                      <h5 className="card-title text-xl-center">Oscar Ruiz - Backend</h5>
                      <div className="row">
                      <div className="col col-sm"></div>
                        <div className="col col-sm-4">
            ...
            <div className="container"><br/>
                ...
                <div className="col-md-4">
                  <div className="card">
                      ...
                      <div className="card-body">
                      <h5 className="card-title text-xl-center">Julián Perna - Frontend</h5>
                      <div className="row">
                      <div className="col col-sm"></div>
                        <div className="col col-sm-4">
              ...
              <div className="col-md-4">
                  <div className="card">
                      ...
                      <div className="card-body">
                      <h5 className="card-title text-xl-center">Richard Irala - Frontend</h5>
                      <div className="row">
                      <div className="col col-sm"></div>
                        <div className="col col-sm-4">
